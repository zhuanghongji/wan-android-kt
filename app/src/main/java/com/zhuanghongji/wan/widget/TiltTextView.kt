package com.zhuanghongji.wan.widget
...
class TiltTextView : View {
    ...
    companion object {
        private const val MODE_LEFT_TOP = 0
        private const val MODE_LEFT_TOP_TRIANGLE = 1
        private const val MODE_LEFT_BOTTOM = 2
        private const val MODE_LEFT_BOTTOM_TRIANGLE = 3
        private const val MODE_RIGHT_TOP = 4
        private const val MODE_RIGHT_TOP_TRIANGLE = 5
        private const val MODE_RIGHT_BOTTOM = 6
        private const val MODE_RIGHT_BOTTOM_TRIANGLE = 7
    }
